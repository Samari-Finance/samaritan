...
shillreddit = 'Welcome Samaritans!\n'\
    '⏳ We’re going live soon! Countdown Link \n'\
    '🏵 What is Samari?\n'\
    ...
    '• 2% to the charity wallet\n• 1% to the marketing wallet'\
              'Initial Burn: 5%\nTeam: 20%\nPancakeSwap LP: 75%\nTotal Supply: 1,xxx,000,000,000\n'\
...
commands = {
    ...
    "website": 'Samari.finance',
    "chart": '$SAMA is currently untracked due to not being launched.',  # todo
